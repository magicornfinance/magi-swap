...
export const gradients = {
  ...
  purpleDimDark: 'linear-gradient(143.3deg,rgb(48 47 53 / 60%) -185.11%,rgb(37 36 51 / 60%) 49.63%)',
  purpleDim:
    'linear-gradient(118.9deg, rgba(255, 255, 255, 0.2) -0.59%, rgba(0, 0, 0, 0) 132.78%), rgba(80, 74, 123 , 0.7);',
}
