...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    text2: darkMode ? '#EBE9F8' : '#292935',
    text3: darkMode ? '#DDDAF8' : '#8E89C6',
    text4: darkMode ? '#C0BAF6' : '#A7A0E4',
    text5: darkMode ? '#ada2d4' : '#C0BAF6',
    text6: '#504D72',

    // backgrounds / greys
    bg1: darkMode ? '#191A24' : '#FFFFFF',
    bg1And2: darkMode ? '#20202b' : '#FFFFFF',
    bg2: darkMode ? '#272734' : '#EBE9F8',
    bg3: darkMode ? '#262538' : '#DDDAF8',
    ...
    //primary colors
    primary1: darkMode ? '#7345ff' : '#551a8b',
